      ...
      <div className="relative w-full">
        ...
        {inputConfig?.action && (
          <Button
            ...
            variant="default"
            size="sm"
            onClick={inputConfig.action.onClick}
            className={cn(
              "absolute right-1 top-1/2 h-7 -translate-y-1/2 px-3 text-xs",
              inputConfig.action.isPending && "cursor-not-allowed",
              inputConfig.action.customClassName
            )}
            disabled={inputConfig.action.isPending}
          >
            <LoaderRenderer
              status={inputConfig.action.isPending ? "loading" : "default"}
              statuses={{
                default: { icon: null, text: inputConfig.action.label },
                loading: {
                  icon: <Loader2 className="h-4 w-4 animate-spin" />,
                  text:
                    inputConfig.action.loadingLabel || inputConfig.action.label,
                },
              }}
            />
          </Button>
    ...
    return (
      ...
      >
        ...
        <Select
          ...
          disabled={disabled}
        >
          <SelectTrigger className="w-full focus:ring-red-600">
            ...
            {showAction?.position === "bottom-left" && (
              <Button
                ...
                className={cn(
                  ...
                  textareaConfig.action?.customClassName
                )}
